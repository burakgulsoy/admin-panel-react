...
class ViewTasksInProgress extends Component {
        ...
        return (
            <div>
                <Table striped hover bordered>
                    ...
                    <tbody>
                        {this.props.inProgressTasks.map(task => (
                            <tr key={task.task_id}>
...
export default connect(mapStateToProps, mapDispatchToProps)(ViewTasksInProgress)
